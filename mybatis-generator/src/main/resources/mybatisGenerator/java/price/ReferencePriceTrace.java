...
public class ReferencePriceTrace implements Serializable {
    private Integer id;
    ...
    private Integer priceSourceType;
    ...
    public void setPriceSourceType(Integer priceSourceType) {
    ...
    public boolean equals(Object that) {
        ...
        ReferencePriceTrace other = (ReferencePriceTrace) that;
